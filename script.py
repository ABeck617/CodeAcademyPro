...
lovely_loveseat_description = """Lovely Loveseat. Tufted polyester blend on wood. 32 
...
#Great, now let’s create a price for the loveseat. Create a variable lovely_loveseat_price and 
# set it equal to 254.00.
...
# Let’s store that in a variable as well. Define the variable sales_tax and set it equal to .088. That’s 8.8%.
sales_tax = .088
